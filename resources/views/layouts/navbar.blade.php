{{-- <nav class="navbar navbar-expand-lg bg-body-tertiary inter-500 fixed-top mw-100 border-bottom " style="min-width: 100%">
 ...
 <nav class="navbar navbar-expand-lg bg-body border-bottom fixed-top px-2">
